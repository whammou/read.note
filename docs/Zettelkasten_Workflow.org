...
#+FILETAGS: :topRead:typDoc:subProject:PKM:ZETTELKASTEN:
- *OBJECTIVE:* Visualize how to a zettelkasten workflow looks like
* [#A] Note Translating Process Workflow
:PROPERTIES:
...
* [#A] Linking Process Between Notes
:PROPERTIES:
...
- *[NOTE]* taken on [2025-06-30 01:18]:
  ...
  - Keyword note is similar to an index note except at a more general level
    - Represent in a form of a TOC
      ...
      #+end_html
* [#A] Zettelkasten note search and access
:PROPERTIES:
